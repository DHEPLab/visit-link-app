...
it('should recursive page case components', () => {
        ...
        new Case(
          ...
          [
            new Component(
              'Switch',
              111,
              new SwitchValue(new TextValue(), [new Case(1111, 'Level 2 Case 1', ['Continue'], [])])
            ),
        ...
        new Case(
          ...
          [
            new Component(
              'Switch',
              121,
              new SwitchValue(new TextValue(), [new Case(1211, 'Level 2 Case 1', ['Continue'], [])])
            ),
  ...
  case11.pageComponents = [
    [new Component('Switch', 111, new SwitchValue(new TextValue(), [case1111]))],
    [new Component('Text', 112)],
  ];
  ...
  case12.pageComponents = [
    [new Component('Switch', 121, new SwitchValue(new TextValue(), [case1211]))],
    [new Component('Text', 122)],
  ];
  expect(module.pageable(components)).toStrictEqual([
    [new Component('Switch', 1, new SwitchValue(new TextValue(), [case11, case12]))],
  ]);
});
