            ...
            <Container>
                ...
                <FormContainer>
                    <StaticForm>
                        ...
                        <StaticField label={t('lessonName')}>{value.lessonName}</StaticField>
                        <StaticField label={t('visitTime')}>
                            {i18n.language==='zh'?Visit.formatDateTimeCN(value.visitTime):Visit.formatDateTimeEN(value.visitTime)}
                        </StaticField>
                    </StaticForm>
                </FormContainer>
                {redDot && <RedDot/>}
